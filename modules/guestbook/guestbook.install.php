...
//		$entries = $sql->getCache('guestbook_'.$pager->current);
		...
		// Deleting entry
		else if (ctype_digit($_POST['delete_id'])
			&& $_POST['auth'] == AUTH
	...
	private function formSumbit()
	{
		...
		$this->err
			...
			->condition(!$form['edit_mode'] && defined('FLOOD'))
